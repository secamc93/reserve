 ...
 * Maneja las operaciones CRUD de resources
...
import {
  ...
  BackendCreateResourceResponse,
  BackendUpdateResourceResponse,
  BackendDeleteResourceResponse,
} from './response/resources.response';
...
export class ResourcesRepository implements IResourcesRepository {
  async getResources(params: GetResourcesParams): Promise<ResourcesList> {
    ...
    try {
      ...
      const resources = (backendResponse.data.resources || []).map((resource) => ({
        id: resource.id,
        name: resource.name,
  ...
  async createResource(params: CreateResourceParams): Promise<CreateResourceResponse> {
  ...
  async updateResource(params: UpdateResourceParams): Promise<UpdateResourceResponse> {
  ...
  async deleteResource(params: DeleteResourceParams): Promise<DeleteResourceResponse> {
    ...
    try {
      ...
      return {
        success: true,
        message: backendResponse.message || `Recurso eliminado con ID: ${id}`,
      };
    } catch (error) {
