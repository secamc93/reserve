...
import { RemoveRolePermissionUseCase } from '../../application/remove-role-permission.use-case';
import { RemoveRolePermissionRepository } from '../repositories/remove-role-permission.repository';
