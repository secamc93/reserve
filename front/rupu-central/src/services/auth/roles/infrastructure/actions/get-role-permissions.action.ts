...
import { GetRolePermissionsUseCase } from '../../application/get-role-permissions.use-case';
import { GetRolePermissionsRepository } from '../repositories/get-role-permissions.repository';
