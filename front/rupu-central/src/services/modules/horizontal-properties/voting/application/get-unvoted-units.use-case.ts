import { getUnvotedUnitsAction, type GetUnvotedUnitsInput, type GetUnvotedUnitsResult } from '@/services/modules/horizontal-properties/voting/infrastructure/actions/get-unvoted-units.action';
