...
import { updatePermissionAction } from '../../infrastructure/actions/permissions/update-permission.action';
import { XMarkIcon } from '@heroicons/react/24/outline';
import { useBusinessTypes, useResources, useActions } from '../hooks';
...
export function EditPermissionModal({
  ...
  useEffect(() => {
    const fetchPermissionDetails = async () => {
      ...
      try {
        const { getPermissionByIdAction } = await import(
          '../../infrastructure/actions/permissions/get-permission-by-id.action'
        );
