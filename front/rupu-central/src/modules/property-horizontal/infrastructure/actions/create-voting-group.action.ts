...
import { CreateVotingGroupUseCase } from '../../application/create-voting-group.use-case';
import { VotingGroupsRepository } from '../repositories/voting-groups.repository';
import { VotingGroup, CreateVotingGroupDTO } from '../../domain/entities/voting-group.entity';
