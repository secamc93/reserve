/**
 * Layout para paginas de Sport Training
 */
'use client';
...
export default function SportTrainingLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Guard: verificar que el tipo activo sea sport_training
    const activeType = TokenStorage.getActiveBusinessType();
    if (activeType && activeType !== 'sport_training') { router.push('/select-type'); return; }
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        {/* Top bar con dropdown de negocio */}
