...
export class ReservationRepositoryImpl implements ReservationRepository {
  ...
  async getReservations(filters?: ReservationFilters) {
    try {
      ...
      console.error('Error en ReservationRepositoryImpl.getReservations:', error);
      return {
        success: false,
        data: [],
        total: 0,
  ...
  async createReservation(reservationData: CreateReservationData) {
    try {
      ...
      console.error('Error en ReservationRepositoryImpl.createReservation:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Error de conexión'
      };
  ...
  async updateReservationStatus(data: UpdateReservationStatusData) {
    try {
      ...
      console.error('Error en ReservationRepositoryImpl.updateReservationStatus:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Error de conexión'
      };
  ...
  async cancelReservation(reservationId: number) {
    try {
      ...
      console.error('Error en ReservationRepositoryImpl.cancelReservation:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Error de conexión'
      };
  ...
  async getReservationById(reservationId: number) {
    try {
      ...
      console.error('Error en ReservationRepositoryImpl.getReservationById:', error);
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Error de conexión'
      };
