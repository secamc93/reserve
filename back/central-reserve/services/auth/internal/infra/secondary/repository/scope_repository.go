...
func (r *Repository) GetScopes(ctx context.Context) ([]domain.Scope, error) {
...
func (r *Repository) GetScopeByID(ctx context.Context, id uint) (*domain.Scope, error) {
...
func (r *Repository) GetScopeByCode(ctx context.Context, code string) (*domain.Scope, error) {
	var scope domain.Scope
...
func (r *Repository) CreateScope(ctx context.Context, scope domain.Scope) (string, error) {
...
func (r *Repository) UpdateScope(ctx context.Context, id uint, scope domain.Scope) (string, error) {
...
func (r *Repository) DeleteScope(ctx context.Context, id uint) (string, error) {
	if err := r.database.Conn(ctx).Table("scope").Where("id = ?", id).Delete(&domain.Scope{}).Error; err != nil {
