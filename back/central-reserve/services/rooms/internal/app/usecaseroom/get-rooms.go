...
func (uc *RoomUseCase) GetRooms(ctx context.Context) ([]entities.Room, error) {
...
func (uc *RoomUseCase) GetRoomsByBusinessID(ctx context.Context, businessID uint) ([]entities.Room, error) {
	if businessID == 0 {
...
func (uc *RoomUseCase) GetRoomByID(ctx context.Context, id uint) (*entities.Room, error) {
	if id == 0 {
...
func (uc *RoomUseCase) GetRoomByCodeAndBusiness(ctx context.Context, code string, businessID uint) (*entities.Room, error) {
	if code == "" {
