...
func (h *ResidentHandler) BulkUpdateResidents(c *gin.Context) {
	...
	if err != nil {
		fmt.Fprintf(os.Stderr, "[ERROR] handlers/bulk-update-residents.go - Error creando archivo temporal: %v\n", err)
	...
	if err := c.SaveUploadedFile(file, tempFile.Name()); err != nil {
		fmt.Fprintf(os.Stderr, "[ERROR] handlers/bulk-update-residents.go - Error guardando archivo: %v\n", err)
