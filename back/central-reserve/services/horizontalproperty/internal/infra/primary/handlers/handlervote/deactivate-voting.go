...
//	@Router			/horizontal-properties/voting-groups/{group_id}/votings/{voting_id} [delete]
func (h *VotingHandler) DeactivateVoting(c *gin.Context) {
	idParam := c.Param("voting_id")
	id64, err := strconv.ParseUint(idParam, 10, 32)
	if err != nil {
		fmt.Fprintf(os.Stderr, "[ERROR] handlervote/deactivate-voting.go - Error en handler: %v\n", err)
