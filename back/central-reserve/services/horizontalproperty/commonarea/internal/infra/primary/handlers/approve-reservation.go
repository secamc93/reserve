...
// ApproveReservation aprueba una reserva
func (h *CommonAreaHandler) ApproveReservation(c *gin.Context) {
	...
	reservation, err := h.useCase.ApproveReservation(ctx, uint(id), userID)
	if err != nil {
