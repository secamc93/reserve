...
func New(db db.IDatabase, logger log.ILogger) *AttendanceRepository {
...
func (r *AttendanceRepository) CreateAttendanceList(ctx context.Context, attendanceList domain.AttendanceList) (*domain.AttendanceList, error) {
...
func (r *AttendanceRepository) GetAttendanceListByID(ctx context.Context, id uint) (*domain.AttendanceList, error) {
...
func (r *AttendanceRepository) GetAttendanceListByVotingGroup(ctx context.Context, votingGroupID uint) (*domain.AttendanceList, error) {
	var m models.AttendanceList
...
func (r *AttendanceRepository) DeleteAttendanceList(ctx context.Context, id uint) error {
...
func (r *AttendanceRepository) CreateProxy(ctx context.Context, proxy domain.Proxy) (*domain.Proxy, error) {
	m := &models.Proxy{
...
func (r *AttendanceRepository) GetProxyByID(ctx context.Context, id uint) (*domain.Proxy, error) {
	var m models.Proxy
	if err := r.db.Conn(ctx).First(&m, id).Error; err != nil {
		if err == gorm.ErrRecordNotFound {
...
func (r *AttendanceRepository) GetProxiesByPropertyUnit(ctx context.Context, propertyUnitID uint) ([]domain.Proxy, error) {
	var m []models.Proxy
...
func (r *AttendanceRepository) GetActiveProxiesByPropertyUnit(ctx context.Context, propertyUnitID uint) ([]domain.Proxy, error) {
	var m []models.Proxy
	now := time.Now()
...
func (r *AttendanceRepository) DeleteProxy(ctx context.Context, id uint) error {
...
func (r *AttendanceRepository) CreateAttendanceRecord(ctx context.Context, record domain.AttendanceRecord) (*domain.AttendanceRecord, error) {
...
func (r *AttendanceRepository) GetAttendanceRecordByID(ctx context.Context, id uint) (*domain.AttendanceRecord, error) {
...
func (r *AttendanceRepository) GetAttendanceRecordByListAndUnit(ctx context.Context, attendanceListID, propertyUnitID uint) (*domain.AttendanceRecord, error) {
	var m models.AttendanceRecord
...
func (r *AttendanceRepository) UpdateAttendanceRecord(ctx context.Context, id uint, record domain.AttendanceRecord) (*domain.AttendanceRecord, error) {
	var m models.AttendanceRecord
	if err := r.db.Conn(ctx).First(&m, id).Error; err != nil {
		if err == gorm.ErrRecordNotFound {
			return nil, fmt.Errorf("registro de asistencia no encontrado")
...
func (r *AttendanceRepository) UpdateAttendanceRecordSimple(ctx context.Context, id uint, attendedAsOwner, attendedAsProxy bool) (*domain.AttendanceRecord, error) {
	r.logger.Info().
		Uint("id", id).
...
func (r *AttendanceRepository) DeleteAttendanceRecord(ctx context.Context, id uint) error {
...
func (r *AttendanceRepository) CreateAttendanceRecordsInBatch(ctx context.Context, records []domain.AttendanceRecord) error {
	if len(records) == 0 {
		return nil
	}
...
func (r *AttendanceRepository) DeleteAttendanceRecordsByList(ctx context.Context, attendanceListID uint) error {
...
func (r *AttendanceRepository) GenerateAttendanceListForVotingGroup(ctx context.Context, votingGroupID uint) ([]domain.AttendanceRecord, error) {
...
func (r *AttendanceRepository) GetAttendanceSummary(ctx context.Context, attendanceListID uint) (*domain.AttendanceSummaryDTO, error) {
	var result struct {
...
func (r *AttendanceRepository) GetVotingGroupTitleByListID(ctx context.Context, attendanceListID uint) (string, error) {
	var title string
	if err := r.db.Conn(ctx).
...
func (r *AttendanceRepository) UpdateAttendanceRecordsByPropertyUnit(ctx context.Context, propertyUnitID uint, proxyID *uint) error {
	updates := map[string]interface{}{}
	if proxyID != nil {
