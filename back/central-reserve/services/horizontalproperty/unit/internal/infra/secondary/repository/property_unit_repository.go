...
func New(db db.IDatabase, logger log.ILogger) *PropertyUnitRepository {
...
func (r *PropertyUnitRepository) CreatePropertyUnit(ctx context.Context, unit *domain.PropertyUnit) (*domain.PropertyUnit, error) {
...
func (r *PropertyUnitRepository) GetPropertyUnitByID(ctx context.Context, id uint) (*domain.PropertyUnit, error) {
...
func (r *PropertyUnitRepository) ListPropertyUnits(ctx context.Context, filters domain.PropertyUnitFiltersDTO) (*domain.PaginatedPropertyUnitsDTO, error) {
...
func (r *PropertyUnitRepository) UpdatePropertyUnit(ctx context.Context, id uint, unit *domain.PropertyUnit) (*domain.PropertyUnit, error) {
	model := &models.PropertyUnit{
		Number:                   unit.Number,
		Floor:                    unit.Floor,
		Block:                    unit.Block,
...
func (r *PropertyUnitRepository) DeletePropertyUnit(ctx context.Context, id uint) error {
...
func (r *PropertyUnitRepository) ExistsPropertyUnitByNumber(ctx context.Context, businessID uint, number string, excludeID uint) (bool, error) {
	var count int64
